...
namespace kim\present\startkit\task;
...
class CheckUpdateAsyncTask extends AsyncTask{
	...
	private const RELEASE_URL = "https://api.github.com/repos/PresentKim/StartKit-PMMP/releases/latest";
	...
	public function __construct(){
		$this->cachePath = StartKit::getInstance()->getDataFolder() . ".latestCache";
	}
